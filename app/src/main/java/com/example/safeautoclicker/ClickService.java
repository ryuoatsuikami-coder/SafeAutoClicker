...
public class ClickService extends AccessibilityService {
    ...
    private void showFloatingControls() {
        ...
        saveBtn.setOnClickListener(v -> {
            ...
            Toast.makeText(this, "Saved: " + crossX + ", " + crossY, Toast.LENGTH_SHORT).show();
        });
        ...
        startBtn.setOnClickListener(v -> {
            ...
            Toast.makeText(this, "Started. Open Magic Merge screen.", Toast.LENGTH_SHORT).show();
        });
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        if (event.getPackageName() != null) {
            ...
            if (!pkg.equals("com.example.safeautoclicker")) {
                currentPackage = pkg;
            }
        }
    }
